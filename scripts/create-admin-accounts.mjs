 ...
 */
const ADMINS = [
  // Plus-addressed on one real inbox (cictrix23@gmail.com) so Supabase's
  // password-recovery email actually arrives. The earlier made-up addresses
  // made self-service reset impossible -- every change needed SQL or the admin API.
  { email: 'cictrix23+pm@gmail.com',  role: 'PM',  name: 'PM Admin',  label: 'PM Admin (Performance Management)' },
  { email: 'cictrix23+lnd@gmail.com', role: 'LND', name: 'L&D Admin', label: 'L&D Admin (Learning & Development)' },
  ...
  { email: 'cictrix23+superadmin@gmail.com', role: 'ADMIN', name: 'Super Admin', label: 'Super Admin (HR Head, read-only viewer)' },
  { email: 'cictrix23+rsp@gmail.com',        role: 'RSP',   name: 'RSP Admin',   label: 'RSP Admin (Recruitment)' },
];
