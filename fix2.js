...
content = content.replace(
  /import \{ supabase as supabaseClient \} from '\.\.\/\.\.\/lib\/supabase';\s*\/\/[^\n]*\n\/\/[^\n]*\nconst supabase = supabaseClient as any;/g,
  "import { getAllEmployees } from '../../lib/api/employees';"
);

// Replace fetchPositions
content = content.replace(
  /const fetchPositions = async \(\) => \{[\s\S]*?\n  \};\n/g,
...
// Replace handlePositionClick
content = content.replace(
  /const handlePositionClick = async \(position: Position\) => \{[\s\S]*?\n  \};\n/g,
